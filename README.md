...
<head>
  ...
  <title>Chandrika Enterprises | Electrical Retail & Services</title>
  <style>
    body {
...
<body>
  ...
  <section id="contact" class="contact">
    ...
    <p>📍 Address: (Add your shop address here)</p>
    <p>📞 Phone: (Add your contact number)</p>
    <p>✉️ Email: (Add your email ID)</p>
  </section>
